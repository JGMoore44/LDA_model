...
To start this problem, we will load our training and test sets.

```{r}
#load traing set
setwd("C:/2018_Fall/STAT_488/homework")
trainSet = read.csv("PA_HW1_train.csv")

#load test set
testSet = read.csv("PA_HW1_test.csv")
```
